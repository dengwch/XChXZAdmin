...
public class UserService {
	...
	/*public PageData findBycodename(PageData pd) throws Exception {
		return (PageData) dao.findForObject("UserXMapper.findBycodename", pd);
	}*/
	...
	/*public void deleteCode(PageData pd) throws Exception {
		dao.delete("UserXMapper.deleteCode", pd);
	}*/
	...
	/*public List<PageData> listPageCode(Page page) throws Exception {
		return (List<PageData>) dao.findForList("UserXMapper.codelistPage", page);
	}*/
