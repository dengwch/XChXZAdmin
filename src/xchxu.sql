...
Source Database       : xchxu

Target Server Type    : MYSQL
Target Server Version : 50612
File Encoding         : 65001

Date: 2017-05-14 00:49:04
*/
...
CREATE TABLE `businessuser` (
  ...
  `BUSINESSUSERNAME` varchar(255) DEFAULT NULL COMMENT '商家用户名手机号',
...
INSERT INTO `sys_menu` VALUES ('7', '申请商家', 'businessuser/SQlist.do', '6', '2', null, '2');
...
INSERT INTO `sys_menu` VALUES ('11', '注册商家审核', 'businessuser/ZClist.do', '6', '3', null, '2');
INSERT INTO `sys_menu` VALUES ('12', '添加商家', 'businessuser/goAdd.do', '6', '4', null, '2');
INSERT INTO `sys_menu` VALUES ('17', '商家管理列表', 'businessuser/list.do', '6', '1', null, '2');
INSERT INTO `sys_menu` VALUES ('15', '商品管理', '#', '0', '6', 'icon-desktop', '');
INSERT INTO `sys_menu` VALUES ('16', '意见反馈列表', 'feedback/list.do', '13', '1', null, '');
INSERT INTO `sys_menu` VALUES ('18', '业务管理列表', 'work/list.do', '8', '1', null, '');
INSERT INTO `sys_menu` VALUES ('19', '热门管理', '#', '14', '1', null, '');
INSERT INTO `sys_menu` VALUES ('20', '轮播图管理', '#', '14', '2', null, '');
INSERT INTO `sys_menu` VALUES ('21', '商品管理列表', '#', '15', '1', null, '');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '系统管理员', '4192742', '0', '1', '1', '1', '1', '1');
INSERT INTO `sys_role` VALUES ('3f7b85a324344d3c82982d33e316019a', '分销商管理员', '4192742', '1', '2022', '192', '2022', '2022', '3f7b85a324344d3c82982d33e316019a');
INSERT INTO `sys_role` VALUES ('522c5b0d924c4ebfbf337dde50630c7e', '管理员', '4192742', '1', '4192742', '4070', '4070', '4070', '522c5b0d924c4ebfbf337dde50630c7e');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'de41b7fb99201d8334c23c014db35ecd92df81bc', '系统管理员', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2017-05-14 00:01:27', '127.0.0.1', '0', '最高统治者', 'default', 'admin@main.com', '001', '18788888888', null);
...
CREATE TABLE `tb_businessuser` (
  `BUSINESSUSER_ID` varchar(100) NOT NULL,
  `BUSINESSUSERNAME` varchar(255) DEFAULT NULL COMMENT '商家名称',
  `BUSINESSPWD` varchar(255) DEFAULT NULL COMMENT '登录密码',
  ...
  `BUSINESSLICENSEURL` varchar(255) DEFAULT NULL COMMENT '营业执照',
  `SHOPNAME` varchar(255) DEFAULT NULL COMMENT '店铺名称',
  `SHOPADDRESS` varchar(255) DEFAULT NULL COMMENT '店铺地址',
  `SHOPLOGO` varchar(255) DEFAULT NULL COMMENT '店铺logo',
  `WORK` varchar(255) DEFAULT NULL COMMENT '主营业务',
  `FLAG` varchar(255) DEFAULT NULL COMMENT '1正常2禁用3下架',
  `CREATIME` varchar(255) DEFAULT NULL COMMENT '创建时间',
  `CONTACTSNAME` varchar(255) DEFAULT NULL COMMENT '联系人',
  `SQFLAG` varchar(255) DEFAULT NULL COMMENT '1未处理2已处理',
  `ZCFLAG` varchar(255) DEFAULT NULL COMMENT '1待审核2审核通过3审核失败',
...
-- ----------------------------
INSERT INTO `tb_businessuser` VALUES ('1999f8c2572e47d5a3a588eb0c7388bf', '12', '1', '1115126954@qq.com', '1', '12', 'upload/user/d289d66a35314e2e9dba3a221edb2503/ca7b8e10ccd848fa8b9aae7179c3481d/1c60eb0a294c4ba9879f98e941c0d88b.jpg', '1', '1', 'upload/user/d289d66a35314e2e9dba3a221edb2503/ca7b8e10ccd848fa8b9aae7179c3481d/1c60eb0a294c4ba9879f98e941c0d88b.jpg', '2b75e4d1094147f1bf9cfcac05c23b5e', '1', '2017-05-12 17:47:30', '1', '2', '2', '低功耗');
INSERT INTO `tb_businessuser` VALUES ('ce68ade5791e4921be891c6f55901e59', 'huguowang', '4a7894875a16c8190741770f9b97305e', '18322781189', '法国恢复', '功夫', 'upload/user/d289d66a35314e2e9dba3a221edb2503/ca7b8e10ccd848fa8b9aae7179c3481d/1c60eb0a294c4ba9879f98e941c0d88b.jpg', '大地飞歌', '1', 'upload/user/d289d66a35314e2e9dba3a221edb2503/ca7b8e10ccd848fa8b9aae7179c3481d/1c60eb0a294c4ba9879f98e941c0d88b.jpg', '2b75e4d1094147f1bf9cfcac05c23b5e', '1', '2017-05-12 17:47:31', '复兴风格', '2', '3', '呼呼');
INSERT INTO `tb_businessuser` VALUES ('d289d66a35314e2e9dba3a221edb2503', '1', '1', '1', '1', '1', 'upload/user/d289d66a35314e2e9dba3a221edb2503/ca7b8e10ccd848fa8b9aae7179c3481d/1c60eb0a294c4ba9879f98e941c0d88b.jpg', '1', '1', 'upload/user/d289d66a35314e2e9dba3a221edb2503/ca7b8e10ccd848fa8b9aae7179c3481d/1c60eb0a294c4ba9879f98e941c0d88b.jpg', 'fd04a6a7849d40639235d63b0431ea13', '1', '2017-05-12 17:40:23', '1', '1', '1', null);
...
CREATE TABLE `tb_feedback` (
  ...
  `CREATETIME` datetime DEFAULT NULL COMMENT '创建时间',
  `BUSINESSUSER_ID` varchar(255) DEFAULT NULL COMMENT '商家id',
  `FLAG` varchar(255) DEFAULT NULL COMMENT '状态1正常2未处理',
...
-- ----------------------------
INSERT INTO `tb_feedback` VALUES ('2f983894c9494e58a5f6c82edc8f25d3', 'asbjkahkj中文啊', '1', '2017-03-14 20:04:06', 'ce68ade5791e4921be891c6f55901e59', null);
INSERT INTO `tb_feedback` VALUES ('972428ef6c4a4f28bf84462ece864b03', '意见反馈', '1', '2017-03-16 10:53:38', 'ce68ade5791e4921be891c6f55901e59', null);
INSERT INTO `tb_feedback` VALUES ('d04545f8bdbc4bf697002425e4b51ab2', '4112412414141', '1', '2017-04-24 17:27:57', 'ce68ade5791e4921be891c6f55901e59', null);
...
CREATE TABLE `tb_work` (
  ...
  `WORKNAME` varchar(255) DEFAULT NULL COMMENT '业务名称',
  `CREATETIME` varchar(255) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`WORK_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of tb_work
-- ----------------------------
INSERT INTO `tb_work` VALUES ('2b75e4d1094147f1bf9cfcac05c23b5e', '女装', '2017-05-12 17:18:35');
INSERT INTO `tb_work` VALUES ('9c09f78be2fd487097b25610f9901013', '男装', '2017-05-12 17:06:10');
INSERT INTO `tb_work` VALUES ('b09d604a23264fde8e9af2ea8817b0bc', '母婴', '2017-05-12 17:18:53');
INSERT INTO `tb_work` VALUES ('fd04a6a7849d40639235d63b0431ea13', '美妆', '2017-05-12 17:19:04');
