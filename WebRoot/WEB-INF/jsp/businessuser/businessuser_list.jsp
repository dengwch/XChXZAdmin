							...
							<tr>
								...
								<td class='center' style="width: 30px;vertical-align: middle;">${vs.index+1}</td>
										...
										<c:if test="${var.varList.TYPE==3}">
											...
											<c:if test="${var.varList.FLAG!=1 && var.varList.FLAG!=2 && var.varList.FLAG!=3}">
												<td class='center' style="vertical-align: middle;">暂无</td>
											</c:if>
										</c:if>
										<c:if test="${var.varList.TYPE==2}">
										...
										<c:if test="${var.varList.TYPE!=2 &&  var.varList.TYPE!=3}">
											<td class='center' style="vertical-align: middle;">暂无</td>
										</c:if>
