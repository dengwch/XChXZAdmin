...
class='center' style="vertical-align: middle;">${var.varList.CREATIME}</td>
							...
							<c:if test="${QX.edit != 1 && QX.del != 1 }">
								...
								<a class="btn btn-small btn-success"
									onclick="xq('${var.varList.BUSINESSUSER_ID}');">详情</a>
									<a class="btn btn-small btn-success"
									onclick="editpass('${var.varList.BUSINESSUSER_ID}');">修改密码</a>
								<c:if test="${var.varList.ZCFLAG==1}">
...
<script type="text/javascript">
		...
		function gFlag(Id,flag){
			var url = "<%=basePath%>businessuser/ZClist.do?BUSINESSUSER_ID="+Id+"&ZCFLAG2="+flag;
