...
<base href="<%=basePath%>">
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath }/resources/layer/extend/layer.ext.js"></script> 
	...
	<!-- basic scripts -->
		...
		function listnotice(id){
			...
			layer.open({
	    	    ...
	    	    shade: false,
	    	    title: false,
	    	    content: locat1+'/businessuser/ZClist1.do?BUSINESSUSER_ID='+id
	        	    //$('#uploader')
	    	});
			//window.location.href='<%=basePath%>businessuser/ZClist.do?BUSINESSUSER_ID='+id;
		}
		
		function listallnotice(){
			//新增
				var locat1 = (window.location+'').split('/');
	        	locat1 =  locat1[0]+'//'+locat1[2]+'/'+locat1[3];
				layer.open({
		    	    ...
		    	    shade: false,
		    	    title: false,
		    	    content: locat1+'/businessuser/Noticelist.do'
		        	    //$('#uploader')
		    	});
			//window.location.href='<%=basePath%>businessuser/Noticelist.do?BUSINESSUSER_ID='+id;
		}
		</script>
</body>
</html>
