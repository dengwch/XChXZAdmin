	...
	function save(){
		if($("#PACKAGENAME").val()==""){
			...
			$.ajax({
				type : "post",
				dataType: "json",
				data:{"PACKAGENAME":$("#PACKAGENAME").val(),"BUSINESS_ID":$("#BUSINESS_ID").val()},
...
<body>
	<form action="businesspackage/${msg }.do" name="Form" id="Form" method="post">
		...
		function datil(Id){
			...
			var FWF=$("#FWF").val();
			 window.location.href=window.location.href='${pageContext.request.contextPath}/business/goAdd.do?BUSINESS_ID='+Id+'&BUSINESS_NAME='+BUSINESS_NAME+'&BUSINESS_DESCRIBE='+BUSINESS_DESCRIBE+'&FWF='+FWF;;
		}
		</script>
</body>
</html>